...
public class WithinSight : Conditional
{
    ...
    public WithinSightType withinSightType;
    ...
    {
        switch (withinSightType)
        {
            case WithinSightType.SeekRange:
                return seekRange.Value;
            case WithinSightType.MeleeRange:
                return meleeRange.Value;
            case WithinSightType.ZoneAttackRange:
                return zoneAttackRange.Value;
            case WithinSightType.EscapeRange:
